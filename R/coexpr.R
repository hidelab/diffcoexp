...
#' @export
#' @return a data frame containing gene pairs coexpressed in at least one of the conditions with the criteria that at least one of their correlation coefficients (cor.1 and/or cor.2) is greater that rth with q value (q.1 and/or q.2) less than qth. It has the following columns:
